<x-app-layout>
            ...
            <div class="col-span-2 flex flex-col bg-white">
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-3">
                    ...
                    <div x-show="Object.keys(cart).length === 0" class="text-center text-gray-400 mt-20">
                        <svg class="w-16 h-16 mx-auto mb-4 text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"></path></svg>
                        <p>Cart is empty</p>
                    </div>
                </div>
                ...
                <div class="border-t p-4 bg-gray-50">
                    ...
                    <button class="w-full bg-teal-600 text-white py-3 rounded-lg hover:bg-teal-700 font-bold text-lg disabled:opacity-50" 
    ...
    <script>
        function posApp() {
            return {
                search: '',
                // MAGICAL BRIDGE: Convert PHP session array into Javascript object
                cart: @js(session('cart', [])),
                
                // Pass Blade products to Javascript
